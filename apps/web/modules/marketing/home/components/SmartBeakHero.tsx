...
import { ArrowRightIcon, SparklesIcon, TrendingUpIcon, ShieldCheckIcon, ZapIcon } from "lucide-react";
      ...
      <div className="container max-w-6xl">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="mt-6 text-lg text-foreground/60 sm:text-xl max-w-2xl mx-auto leading-relaxed">
            SmartBeak is the premium multi-tenant SaaS for serious domain portfolio owners. 
            Publish AI-generated content across 11 platforms, track SEO decay signals, 
            and maximise your sell-ready score — all from one dashboard.
          </p>
        </div>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Button size="lg" variant="outline" asChild className="gap-2 px-8 h-12 text-base">
            <Link href="#features">
              See Features
            </Link>
          </Button>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-6">
          {TRUST_BADGES.map(({ icon: Icon, label }) => (
            <div key={label} className="flex items-center gap-2 text-sm text-foreground/50">
          ...
          <div className="rounded-2xl border border-border/50 bg-card shadow-2xl overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-4 gap-4">
              ...
              <div className="col-span-1 space-y-2">
                {["Dashboard", "Domains", "Content", "Publishing", "SEO", "Analytics", "Billing"].map((item, i) => (
                  <div
                    key={item}
              ...
              <div className="col-span-3 space-y-4">
                ...
                <div className="rounded-xl border border-border/50 bg-card overflow-hidden">
                  {["example.com", "mybrand.io", "portfolio.net"].map((domain, i) => (
                    <div key={domain} className={`flex items-center justify-between px-4 py-2.5 text-xs ${i > 0 ? "border-t border-border/30" : ""}`}>
