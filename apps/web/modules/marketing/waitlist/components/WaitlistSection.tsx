            ...
            <>
              ...
              <div className="text-center mb-8">
                ...
                <p className="mt-3 text-foreground/60">
                  Get early access to the AI-powered content publishing platform built for serious domain portfolio owners.
                  {referredBy && (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
                {[
                  ...
                  <div key={label} className="flex items-center gap-2 rounded-xl bg-muted/50 px-4 py-3 text-sm font-medium text-foreground/70">
                    <span>{icon}</span>
                    {label}
                  </div>
                ))}
            ...
            <div className="text-center space-y-6">
              ...
              <div className="rounded-2xl border border-border/50 bg-muted/30 p-6 space-y-4">
                ...
                <p className="text-xs text-foreground/50">
                  Each person who joins using your link moves you up the priority queue. Refer 3+ people to get early access.
                </p>
              </div>
