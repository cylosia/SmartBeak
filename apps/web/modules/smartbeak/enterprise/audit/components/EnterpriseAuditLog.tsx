...
export function EnterpriseAuditLog({ organizationSlug }: EnterpriseAuditLogProps) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Immutable, SOC2-ready event trail for your organization.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Popover>
              ...
              <PopoverContent className="w-64 space-y-3" align="end">
                <p className="text-sm font-semibold">Export Audit Log</p>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Configure how long audit events are retained. SOC2 recommends
                  at least 365 days.
                </CardDescription>
              </div>
            </div>
              ...
              <>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Select
                      value={String(
                        retentionQuery.data?.retention.retentionDays ?? 90,
                      )}
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="365">1 year (SOC2 recommended)</SelectItem>
                        <SelectItem value="730">2 years</SelectItem>
                        <SelectItem value="2555">7 years (maximum)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="flex items-center gap-3 pt-6">
                    <Switch
                      checked={
                        retentionQuery.data?.retention.exportEnabled ?? false
                      }
