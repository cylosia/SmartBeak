...
import { UsersIcon, TrendingUpIcon, MousePointerClickIcon, TargetIcon } from "lucide-react";
...
export function BuyerAttributionView({
  ...
  const isLoading = isDomainLevel ? domainQuery.isLoading : orgQuery.isLoading;
      ...
      <ErrorBoundary>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm font-semibold">Daily Buyer Sessions</CardTitle>
                <CardDescription>30-day session trend</CardDescription>
              </CardHeader>
              <CardContent>
                {data.dailyTrend.length === 0 ? (
                  ...
                  <ResponsiveContainer width="100%" height={200}>
                    <AreaChart data={data.dailyTrend} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
                      ...
                      <Area type="monotone" dataKey="count" stroke="hsl(var(--primary))" fill="url(#sessionGrad)" strokeWidth={2} />
                    </AreaChart>
                  </ResponsiveContainer>
                )}
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm font-semibold">Intent Breakdown</CardTitle>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm font-semibold">Recent Buyer Sessions</CardTitle>
            </CardHeader>
  ...
  return (
    <ErrorBoundary>
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-semibold">Attribution by Domain</CardTitle>
          </CardHeader>
          <CardContent className="p-0">
            <Table>
              <TableHeader>
                ...
                {orgData.domains.map((d) => {
                  ...
                  return (
                    <TableRow key={d.domain.id}>
                      ...
                      <TableCell>
                        <span className={d.conversionRate >= 20 ? "text-green-600 dark:text-green-400 font-medium" : "text-muted-foreground"}>
                          {d.conversionRate}%
                        </span>
                      </TableCell>
                      <TableCell>
