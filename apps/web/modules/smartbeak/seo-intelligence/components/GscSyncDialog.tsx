    ...
    <Dialog open onOpenChange={(open: boolean) => !open && onClose()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Import keyword rankings and impressions from your GSC property.
            Requires a valid OAuth2 access token with Search Console read
            access.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          <div className="space-y-1.5">
            <Label className="text-xs">Site URL (GSC property)</Label>
            <Input
