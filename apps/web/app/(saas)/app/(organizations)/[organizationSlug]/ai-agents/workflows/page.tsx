...
export default function WorkflowsPage({ params }: WorkflowsPageProps) {
	...
	const createMutation = useMutation({
		...
		onSuccess: (data) => {
			...
			router.push(
				`/app/${organizationSlug}/ai-agents/workflows/${(data as { workflow: { id: string } }).workflow.id}`,
			);
		},
			...
			<Dialog open={showCreate} onOpenChange={setShowCreate}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Give your workflow a name and description. You can
							add agents in the builder.
						</DialogDescription>
					</DialogHeader>
