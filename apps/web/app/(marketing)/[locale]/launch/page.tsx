...
export const metadata: Metadata = {
  ...
  description: "SmartBeak launch assets: Loom video script, social media cards, and announcement templates.",
};
      ...
      <div className="container max-w-4xl space-y-16">
        ...
        <div>
          ...
          <p className="mt-4 text-lg text-foreground/60">
            Ready-to-use launch materials for Product Hunt, social media, and email announcements.
          </p>
        </div>

        {/* Loom Video Script */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">Loom Video Script</h2>
          <div className="rounded-2xl border border-border/50 bg-card p-8 space-y-4 text-sm text-foreground/80 leading-relaxed">
            <p className="font-semibold text-foreground text-base">Duration: ~3 minutes</p>
            <div className="space-y-3">
              <p><strong>[0:00–0:15] Hook</strong><br />
              &ldquo;What if you could turn your entire domain portfolio into a content machine — publishing AI-generated articles across 11 platforms, tracking SEO decay before it costs you rankings, and knowing exactly when your domain is sell-ready? That&apos;s SmartBeak.&rdquo;</p>

              <p><strong>[0:15–0:45] Problem</strong><br />
              &ldquo;Most domain portfolio owners are leaving money on the table. Their domains sit idle, their SEO decays, and when it&apos;s time to sell, they have no data to back up their asking price. Managing content, publishing, and analytics across dozens of domains is a full-time job — until now.&rdquo;</p>

              <p><strong>[0:45–1:30] Demo — Dashboard</strong><br />
              &ldquo;This is the SmartBeak dashboard. I can see all my domains, their health scores, SEO performance, and publishing status at a glance. Let me click into one domain...&rdquo;</p>

              <p><strong>[1:30–2:00] Demo — AI Content + SEO</strong><br />
              &ldquo;I&apos;ll hit the AI Ideas button. SmartBeak generates 5 structured content ideas with titles, outlines, estimated read times, and SEO scores — all in about 3 seconds. I can see the real-time content optimizer scoring my draft as I type.&rdquo;</p>

              <p><strong>[2:00–2:30] Demo — Publishing + Sell-Ready</strong><br />
              &ldquo;One click schedules this article to go out on LinkedIn, email, and the web simultaneously. And here&apos;s the Sell-Ready score — SmartBeak&apos;s Diligence Engine has checked ownership, legal, financial, and content signals and given this domain an 84/100 with specific recommendations to hit 95.&rdquo;</p>

              <p><strong>[2:30–3:00] CTA</strong><br />
              &ldquo;SmartBeak is in early access. Join the waitlist at smartbeak.io and lock in founding member pricing — 40% off for life. I&apos;ll see you inside.&rdquo;</p>
            </div>
          </div>
        </section>
        ...
        {/* Social Media Cards */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">Social Media Announcement Templates</h2>
...
Join the waitlist: smartbeak.io/waitlist`,
              },
              {
                ...
                template: `SmartBeak — AI-powered content publishing & portfolio intelligence for domain owners`,
              },
              {
...
Built on Supastarter Pro + Supabase + Vercel. Locked v9 schema. Production-ready from day one.`,
              ...
              <div key={platform} className="rounded-2xl border border-border/50 bg-card overflow-hidden">
        ...
        {/* Email Announcement */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">Email Announcement Template</h2>
          <div className="rounded-2xl border border-border/50 bg-card overflow-hidden">
            <div className="px-6 py-3 border-b border-border/30 bg-muted/30">
              <p className="text-sm font-semibold text-foreground">Subject: SmartBeak is live — your early access is ready</p>
            </div>
            <div className="p-6 text-sm text-foreground/70 leading-relaxed space-y-4">
              <p>Hi [First Name],</p>
              <p>You&apos;re on the SmartBeak waitlist — and today, your early access is ready.</p>
              <p>SmartBeak is the AI-powered content publishing platform I built specifically for domain portfolio owners like you. Here&apos;s what you get from day one:</p>
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>AI content ideas with titles, outlines, and SEO scores</li>
                <li>Real-time content optimizer (live scoring as you type)</li>
                <li>11-platform publishing from one calendar</li>
                <li>Keyword tracking with decay signals</li>
                <li>Diligence Engine + Sell-Ready score</li>
                <li>Portfolio ROI dashboard with buyer attribution</li>
              </ul>
              <p>As a founding member, you&apos;re locked in at <strong>40% off</strong> for as long as you stay subscribed.</p>
              <p>
                <strong>→ Activate your account: [CTA BUTTON]</strong>
              </p>
              <p>If you have any questions, just reply to this email — I read every one.</p>
              <p>Welcome to SmartBeak.<br />— The SmartBeak Team</p>
            </div>
          </div>
        </section>
        ...
        {/* Launch Checklist */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">Launch Checklist</h2>
