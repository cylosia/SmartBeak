...
export const publishingConfig = {
  ...
  defaultMaxRetries: parseIntEnv('PUBLISHING_DEFAULT_MAX_RETRIES', 3, { min: 0, max: 20 }),
  /** Job timeout in milliseconds */
  jobTimeoutMs: parseIntEnv('PUBLISHING_JOB_TIMEOUT_MS', 300000, { min: 1000, max: 3600000 }),
