 ...
 */
export async function encrypt(plaintext: string, secret: string): Promise<Buffer> {
 ...
 */
export async function decrypt(encrypted: Buffer, secret: string): Promise<string> {
	try {
