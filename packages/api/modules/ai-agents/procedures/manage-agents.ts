		...
		const defaults = [
			{
				...
				description:
					"Searches the web, reads sources, and produces structured research briefs.",
...
Always prioritize accuracy over speed. Note any conflicting information.`,
			...
			},
			{
				...
				description:
					"Transforms research and outlines into compelling, SEO-optimized content.",
				config: AiAgentConfigSchema.parse({
					model: "gpt-4o-mini",
					temperature: 0.8,
					maxTokens: 8192,
...
Produce complete, polished drafts that require minimal editing.`,
			...
			},
			{
				...
				description:
					"Reviews and improves content for clarity, accuracy, and SEO.",
				config: AiAgentConfigSchema.parse({
					model: "gpt-4o-mini",
					temperature: 0.4,
					maxTokens: 8192,
