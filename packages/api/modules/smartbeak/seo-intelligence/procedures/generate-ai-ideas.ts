...
const IdeaSchema = z.object({
	title: z
		.string()
		.describe("Compelling SEO-optimized title under 70 characters"),
	metaDescription: z
		.string()
	...
	targetKeywords: z.array(z.string()).describe("3 primary target keywords"),
	contentType: z
...
export const generateAiIdeas = protectedProcedure
	.route({
		...
		summary:
			"Generate AI content ideas with SEO scoring using Vercel AI SDK",
	})
	.input(
		z.object({
