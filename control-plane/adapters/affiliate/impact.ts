...
export class ImpactAdapter implements AffiliateRevenueAdapter {
  ...
  */
  ...
  try {
    ...
    logger.error('Error fetching reports', error instanceof Error ? error : new Error(String(error)));
    throw error;
  }
  }
  ...
  */
  ...
  try {
    ...
    logger.error('Error getting campaign ads', error instanceof Error ? error : new Error(String(error)));
    throw error;
  }
  }
  ...
  */
  ...
  try {
    ...
    logger.error('Error getting deals', error instanceof Error ? error : new Error(String(error)));
    throw error;
  }
  }
  ...
  */
  ...
  try {
    ...
    logger.error('Error getting promo codes', error instanceof Error ? error : new Error(String(error)));
    throw error;
  }
  }
}
