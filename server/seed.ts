    ...
    await db.insert(domains).values([
      {
        ...
        description: "Product comparison and tech review site with affiliate links",
        status: "active",
      },
      {
        name: "strategyhub.co",
      ...
      },
      {
        ...
        description: "SaaS lead generation landing page for GrowthPilot",
        status: "active",
      },
      {
        name: "joes-plumbing.com",
        theme: "local-business",
        description: "Local plumbing service website for Joe's Plumbing",
        status: "active",
      },
      {
